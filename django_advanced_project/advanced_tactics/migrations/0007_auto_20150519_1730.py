...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('advanced_tactics', '0006_auto_20150519_1726'),
    ]
    ...
    operations = [
        migrations.AddField(
            ...
            name='phone',
            field=localflavor.us.models.PhoneNumberField(default=b'XXX-XXX-XXXX', max_length=20),
        ),
        migrations.AddField(
            model_name='userprofile',
            name='state',
        ...
        migrations.AlterField(
            model_name='userprofile',
            name='created',
            field=models.DateTimeField(default=datetime.datetime(2015, 5, 19, 17, 30, 55, 209683)),
        ),
    ]
